...
- ### Assembly of main function.
    ...
    ***********************************
    ...
    0x8048636:       "%d"
    ```
    #### This number compared with `0x149c` (`5276` in decimal), if they are not equal it jump to return.
    ```c
    0x0804850d <+121>:   movl   $0x8048651,(%esp)
    0x08048514 <+128>:   call   0x8048390 <puts@plt>
    0x08048519 <+133>:   mov    $0x1,%eax
    ...
    0x8048651:       "\nInvalid Password!"
    ```
    #### If they are equal it call `system`.
    ```c
    0x080484ee <+90>:    movl   $0x8048639,(%esp)
    0x080484f5 <+97>:    call   0x8048390 <puts@plt>
    0x080484fa <+102>:   movl   $0x8048649,(%esp)
...
- ### Solution.
    #### lets try enter `5276` as a password.
    ```c
